...
from routes import auth, patients, vitals, alerts, ai, pupil, smartwatch  # ← smartwatch added
...
app.include_router(smartwatch.router,  prefix="/api/smartwatch",  tags=["Smartwatch"])  # ← NEW
