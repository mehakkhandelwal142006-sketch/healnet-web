  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', sans-serif", color: C.text }}>
      ...
      <p style={{ color: C.muted, fontSize: 14, marginBottom: 24 }}>
        Upload exported health data from your smartwatch to view charts and insights.
      </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          gap: 16, fontSize: 13, color: C.muted, lineHeight: 1.8
        }}>
          <div>
      ...
      {/* ── Loading ──────────────────────────────────────────────── */}
      {loading && (
        <div style={{ color: C.accent, textAlign: "center", padding: 20, fontSize: 14 }}>
      ...
      {!result && !loading && !error && (
        <div style={{
          ...
          borderRadius: 14, color: C.muted, fontSize: 13,
        }}>
          Upload a CSV file from your smartwatch to see your health data here.
        </div>
      )}
    </div>
  );
